    ...
    <section id="about" className="scroll-mt-16 py-12 px-6 md:px-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          ...
          className="scroll-reveal mb-8 grid max-w-5xl gap-5 text-base leading-relaxed backdrop-blur-sm"
          style={{
            color: 'var(--c-muted)',
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          {stats.map((stat, i) => (
            <div key={stat.label} data-visible={isVisible}
              className="scroll-reveal rounded-lg border p-5 text-center backdrop-blur-sm transition-[border-color,box-shadow,transform] duration-300 hover:scale-[1.02]"
              style={{
